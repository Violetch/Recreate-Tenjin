  ...
  return (
    <>
      <section
        ...
        ref={navbarRef}
      >
        <div className="flex justify-center min-w-full bg-neutral-900 py-2 text-sm text-center font-semibold tracking-wider">
      ...
      {showFixedNavbar && (
        <section className="flex flex-col fixed inset-x-0 bg-white text-neutral-900 transition-all duration-300 z-50">
          <div
            className={clsx(
              "flex justify-between min-w-full relative overflow-hidden px-[50px] border border-b-[1px]",
              {
                "py-14": isSearch,
                "py-7": !isSearch,
              }
